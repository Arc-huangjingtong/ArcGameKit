...
namespace HaiPackage.TMPEffect
{
    /// <summary>
    /// 阴影
    /// </summary>
    ...
    public class UIShadowEffect : BaseMeshEffect //, IParameterTexture
#if UNITY_EDITOR
...
#endif
    {
        ...
        // Serialize Members.
        //################################
        [Tooltip("How far is the blurring shadow from the graphic.")] [FormerlySerializedAs("m_Blur")] [SerializeField] [Range(0, 1)]
        float m_BlurFactor = 1;

        [Tooltip("Shadow effect style.")] [SerializeField]
        ShadowStyle m_Style = ShadowStyle.Shadow;

        [HideInInspector] [System.Obsolete] [SerializeField]
        List<AdditionalShadow> m_AdditionalShadows = new List<AdditionalShadow>();
        ...
        static readonly List<UIShadowEffect> tmpShadows = new List<UIShadowEffect>();
        ...
        public override void ModifyMesh(VertexHelper vh)
        {
            ...
            GetComponents<UIShadowEffect>(tmpShadows);
        ...
        void UpgradeIfNeeded()
        {
            if (0 < m_AdditionalShadows.Count)
            {
                foreach (var s in m_AdditionalShadows)
                {
                    ...
                    var shadow = gameObject.AddComponent<UIShadowEffect>();
